    ...
    <div className="flex flex-wrap items-center justify-between gap-3 md:gap-4 mb-4">
      ...
      <div className="flex flex-wrap items-center gap-2 md:gap-3">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="inline-flex items-center justify-between gap-2 min-w-[180px] border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white text-gray-700 hover:bg-gray-50"
          >
            <span className="truncate">Bulk actions</span>
            <ChevronDown className="w-4 h-4 text-gray-600" />
          </button>
          {menuOpen && (
            <div className="absolute left-0 mt-2 w-64 rounded-xl border border-gray-200 bg-white shadow-xl z-10 overflow-hidden">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="border border-gray-300 rounded-lg pl-9 pr-3 py-2 text-sm w-52 sm:w-72 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 bg-white text-sm text-gray-700">
          ...
          <span className="inline-flex items-center justify-center min-w-6 h-6 px-1 rounded-full bg-blue-50 text-[#2563EB] text-xs font-semibold">{String(todayCount).padStart(2, '0')}</span>
        </div>
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 bg-white text-sm text-gray-700">
          <span>Overdue Follow-up</span>
          <span className="inline-flex items-center justify-center min-w-6 h-6 px-1 rounded-full bg-blue-50 text-[#2563EB] text-xs font-semibold">{String(overdueCount).padStart(2, '0')}</span>
        </div>
      </div>
    </div>
  );
